...
def interview_fmain(character_id):
    create_name_window()
    ...
    interview_window.title("Fiction Character Interview")
    ...
    begin_interview_button = tk.Button(window, text="Main Character Interview", command=lambda: fmain_interview(interview_window, character_id))
