...
def describe_biohistime(character_id):
    ...
    interview_window.title("Biography History, Background, and Timeline Information")
    ...
    begin_interview_button = tk.Button(window, text="Biography History, Background, and Timeline Information", command=lambda: describe_biohistime(interview_window, character_id))
