...
def interview_fplot(character_id):
    create_name_window()
    ...
    interview_window.title("Interview Fiction Plot")
    ...
    begin_interview_button = tk.Button(window, text="Fiction Plot Interview", command=lambda: interview_fplot(interview_window, character_id))
