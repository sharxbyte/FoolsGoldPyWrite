...
def interview_bioplot(character_id):
    ...
    interview_window.title("Interview Biography Plot")
    ...
    begin_interview_button = tk.Button(window, text="Biography Plot Interview", command=lambda: interview_bioplot(interview_window, character_id))
