...
def describe_fhistime(character_id):
    ...
    interview_window = tk.Toplevel(fiction_window)
    interview_window.title("Fiction History, Background, and Timeline Information")
    ...
    begin_interview_button = tk.Button(window, text="Fiction History, Background, and Timeline Information", command=lambda: describe_fhistime(interview_window, character_id))
