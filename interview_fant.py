...
def interview_fant(character_id):
    create_name_window()
    ...
    interview_window = tk.Toplevel(fant_window)
    interview_window.title("fant")
    ...
    begin_interview_button = tk.Button(window, text="Antagonist Interview", command=lambda: interview_fant(interview_window, character_id))
