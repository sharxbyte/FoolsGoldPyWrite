...
def interview_bioant(character_id):
    create_name_window()
    ...
    begin_interview_button = tk.Button(window, text="Antagonist Interview", command=lambda: bioant_interview(interview_window, character_id))
