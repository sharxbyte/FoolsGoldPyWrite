...
def interview_biomain(character_id):
    create_name_window()
    ...
    begin_interview_button = tk.Button(window, text="Main Character Interview", command=lambda: interview_biomain(interview_window, character_id))
