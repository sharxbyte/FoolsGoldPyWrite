...
def describe_nfsetting(character_id):
    ...
    interview_window.title("Non-Fiction Setting Information")
    ...
    begin_interview_button = tk.Button(window, text="Non-Fiction Setting Information", command=lambda: describe_nfsetting(interview_window, character_id))
