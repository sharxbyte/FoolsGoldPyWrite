...
def interview_biosec(character_id):
    create_name_window()
    ...
    interview_window.title("Biography")
    ...
    begin_interview_button = tk.Button(window, text="Secondary Character Interview", command=lambda: biosec_interview(interview_window, character_id))
