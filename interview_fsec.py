...
def interview_fsec(character_id):
    create_name_window()
    ...
    interview_window.title("fiction")
    ...
    begin_interview_button = tk.Button(window, text="Secondary Character Interview", command=lambda: fsec_interview(interview_window, character_id))
