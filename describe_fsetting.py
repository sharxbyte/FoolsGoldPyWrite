...
def describe_fsetting(character_id):
    ...
    interview_window.title("Fiction Setting Information")
    ...
    begin_interview_button = tk.Button(window, text="Fiction Setting Information", command=lambda: describe_fsetting(interview_window, character_id))
